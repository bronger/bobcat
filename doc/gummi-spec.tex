...
\makeatletter
\newcommand*{\contentmodel}[3][\@empty]{\bigskip\begingroup\par\noindent
  \fbox{\vbox{\raggedright\parindent0pt\hangafter1\hangindent1em
      \emph{Content model of} \texttt{\textbf{#2}}:\quad
      \texttt{#3}%
      \ifx#1\@empty\else\par\hangafter1\hangindent1em
      \emph{Further constraints}:\quad#1\par\fi}}\par
  \endgroup\vspace*{1ex}\par\noindent\ignorespaces}
\newenvironment{attributes}{\noindent \emph{Attributes:}}{}
\newcommand*{\attribute}[2]{\par\noindent\hangafter1\hangindent3em\lstinline{#1} --- #2\par}
\makeatother

\contentmodel{Document}{\textit{block}*, Section*}
...
\contentmodel{DefinitionList}{DefinitionListItem*}

\contentmodel{DefinitionListItem}{\textit{Text}, \textit{block}*}

\contentmodel{List}{ListItem*}

\contentmodel{ListItem}{\textit{block}*}

\contentmodel{Paragraph}{\textit{inline}*}

\contentmodel{Section}{Heading, \textit{flow}*, Section*}

\contentmodel{Heading}{\textit{inline}*}
...
\contentmodel[footnotes must not be nested]{Footnote}{\textit{inline}*}

\contentmodel{Emphasize}{\textit{inline}*}

\contentmodel[hyperlinks must not be nested]{Hyperlink}{\textit{inline}*}
\begin{attributes}
  \attribute{url}{the target URL of the hyperlink}
\end{attributes}
  
\contentmodel[roles must not be nested]{Role}{\textit{inline}*}

\contentmodel{Citations}{Citation*}

\contentmodel[citations must not be nested]{Citation}{BibliographyEntry, \textit{inline}*}

\contentmodel{BiblioEntry}{\textit{empty}}

\contentmodel[cross references must not be nested]{CrossReference}{\textit{inline}*}

\contentmodel{Code}{\textit{Text}}

\contentmodel[environments must not be nested]{Environment}{EnvironmentHeading, \textit{block}*}

\contentmodel{EnvironmentHeading}{\textit{inline}*}

\contentmodel{Float}{Caption?, (Subfigure* | \textit{block}*)}

\contentmodel{Subfigure}{Caption?, \textit{block}*}

\contentmodel{Caption}{\textit{inline}*}

\contentmodel{Media}{\textit{empty}}

\contentmodel{IndexEntry}{IndexEntryPart\{1,3\}}

\contentmodel{IndexEntryPart}{\textit{inline}*}
