...
\contentmodel{Document}{\textit{flow}\rep, Section\rep}{}
\begin{attributes}
  \attribute{packages}{set of unicode}{features needed by this document,
    e.\,g.\ tables, formulae etc.  This can be used by the \LaTeX\ backend to
    decide which additional packages must be included.  Normally, it simply
    contains \LaTeX\ package names, but maybe RTF or OpenDocument need further
    possible items in this set.}
\end{attributes}
